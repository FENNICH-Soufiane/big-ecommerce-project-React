...
export const GET_BRAND_LIKE= 'GET_BRAND_LIKE'
...
export const DELETE_CART_FROM_ITEM = 'DELETE_CART_FROM_ITEM'
export const UPDATE_QUANTITY_OF_PRODUCT_IN_CART = 'UPDATE_QUANTITY_OF_PRODUCT_IN_CART'
